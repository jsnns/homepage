...
Everything on the record, in the repo, from day one. That turned out to be the most important architectural choice we made, and it wasn't a choice about the product. It was a choice about the company.
...
None of this was obvious in advance. Most of it we got wrong first. There was a week I was hours from pausing the whole experiment because machine alarms had flooded the human channels. What saved it: an agent produced, verbatim, every unshipped promise from the previous five days, traced the regression, and shipped the structural fix. The record saved the system built on the record.
